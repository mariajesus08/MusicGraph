...
public interface InfluyentUserArtistRepository extends JpaRepository<Influyent_User_Artist,Integer> {
    ...
    Influyent_User_Artist findFirstInfluyent_User_ArtistByNombreArtista(String name);
    Influyent_User_Artist findFirstInfluyent_User_ArtistByNombreUsuarioInfluyente(String name);
