...
TAG=analisis-tbd #tag de la imagen a crear, puede incluir version en formato nombre:version
API=analisis-tbd #nombre del contenedor en tiempo de ejecucion
PORT=9092 #puerto que se quiere exponer hacia el host
HOSTPORT=9092 #puerto del host, mediante el cual se accede al contenedor
