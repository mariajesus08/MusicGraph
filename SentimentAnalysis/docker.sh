...
TAG=analisis-sentimientos #tag de la imagen a crear, puede incluir version en formato nombre:version
API=analisis-sentimientos #nombre del contenedor en tiempo de ejecucion
PORT=8989 #puerto que se quiere exponer hacia el host
HOSTPORT=8989 #puerto del host, mediante el cual se accede al contenedor
